...
export default function ReviewsSection() {
  ...
  },
  {
    id: 2,
    title: "Good Times",
    message: "We chose this beautiful beach home for our family vacation this year in June. The house is stunning inside, the kitchen is a chefs dream, the laundry rooms on all floors is FANTASTIC, your private pool is a HUGE BONUS especially if you have kids. The elevator is a wonderful amity as well. Each bedroom hosts is our bathroom too which is incredible, so NO waiting for a free shower and the hot water is always available too. The location is a short walk to the main strip at 30A which boasts restaurants, souvenir shops, boutique shops, coffee shops, ice cream store, etc. This area is fantastic for anyone who loves to walk or run.",
    date: "08/16/2025",
    name: "Laura Boyd",
  },
  {
  ...
  },
  {
    id: 4,
    title: "Lori Terrell",
    message: "Thank you for a wonderful Christmas for our family!! You cant ask for a better owner who went out of his way for us!! The place was beautiful and that kitchen is wow!! Love love this place!!",
    date: "01/02/2021",
    name: "Jeanne McGehee", // 
  },
];
